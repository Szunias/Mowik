...
powershell.exe -NoLogo -NoProfile -NonInteractive -ExecutionPolicy Bypass -File "%~dp0scripts\build-release.ps1" -Version "2.7.6" -BuildMode UnsignedLocal -PrepareApplicationOnly -PreparedAppManifestPath "%~dp0dist\Mowik-LOCAL-MANIFEST.txt"
