...
powershell.exe -NoLogo -NoProfile -NonInteractive -ExecutionPolicy Bypass -File "%~dp0scripts\build-release.ps1" -BuildMode UnsignedLocal -PrepareApplicationOnly -PreparedAppManifestPath "%~dp0dist\Mowik-LOCAL-MANIFEST.txt"
